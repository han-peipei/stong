...
########################
    ...
    np.save(os.path.join(save_dir, "val_preds_windows.npy"), preds.astype(np.float32))
    np.save(os.path.join(save_dir, "val_trues_windows.npy"), trues.astype(np.float32))
#########################################################################
